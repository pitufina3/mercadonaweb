...
<html lang="en">
  ...
  <body>
    ...
    <header>
        ...
        <button type="button" class="btn btn-round btn-danger float-right"><i class="fas fa-shopping-cart"></i> Compra on-line</button>
...
<nav class="navbar navbar-expand-lg">
        ...
        <div class="card">
            <img class="card-img-top" src="imagen2.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted"><?=date("d-m-Y");?></small></p><button type="button" class="btn btn-primary btn-sm">Responsabilidad Social</button>
                    <br>
                    <br>
        ...
        <div class="card">
            <img class="card-img-top" src="imagen3.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted"><?=date("d-m-Y");?></small></p><button type="button" class="btn btn-primary btn-sm">Productos de proximidad</button>
                </div>
            </div>
        <div class="card">
    ...
    <div id="formulario">
        ...
        <h2>Mercadona cuenta con 1.625 supermercados. <br>Encuentra tu Mercadona más cercano y su horario
        </h2>  
    ...
    <div class="row" id="anuncios">
        ...
        <p></p>
            <p>Puedes realizar cualquier comentario o consulta llamándonos a nuestro
                ...
                enviando&nbsp;<strong> Correo Electrónico</strong>
        ...
        <div id="ofertas-empleo" class="text-center">
            ...
            <button type="button" class="btn btn-primary btn-md">Ofertas de empleo</button>
        </div>
        ...
        <div class="row">
            ...
            <div class="col">
                <p><strong>Atención al cliente</strong></p>
                    <ul>
                        <li><a href=""></a> <i class="fas fa-envelope-square"></a></i>Contacto</li>
                ...
                <div class="col">
                    <div id="logo-footer" class="text-center">
                        <img src="imagencorredor.jpg" alt="Mercadona" width="200px">
                    </div>
